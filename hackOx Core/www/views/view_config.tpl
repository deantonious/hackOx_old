...
<div class="row">
	...
	<div class="input-field col s6">
		...
		<input id="dev_remote_url" name="dev_remote_url" type="text" placeholder="Remote server" value="<tpl:dev_remote_url>" disabled>
...
<div class="row">
	<div class="input-field col s6">
		...
		<input id="dev_id" name="dev_id" type="text" placeholder="Bot access id" value="<tpl:dev_id>" disabled>
		<label for="dev_id">Device Id</label>
	</div>
	<div class="input-field col s6">
		<i class="material-icons prefix">vpn_key</i>
		<input id="dev_key" name="dev_key" type="text" placeholder="Bot access key" value="<tpl:dev_key>" disabled>
...
<div class="row">
	...
	<div class="input-field col s2 m1">
		<a class="btn-floating btn waves-effect waves-light blue tooltipped btn-action" data-action="wifi_scan" data-display="config_wc_ssid" data-interface="config_wc_int" data-position="top" data-delay="50" data-tooltip="Scan for networks"><i class="material-icons">search</i></a>
	</div>
