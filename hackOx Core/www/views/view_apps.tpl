		...
		<div class="row">
			...
			<div class="valign-wrapper">
				...
				<div class="col s1 m1 l1">
					<a class="btn-floating tooltipped waves-effect waves-light green btn-upload-app" data-position="top" data-delay="50" data-tooltip="Upload and install App"><i class="material-icons">file_upload</i></a>
				</div>
			</div>
		</div>
		<div class="row">
