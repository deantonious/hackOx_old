<?php
	class ContentLoader {
        ...
        public function load() {
             ...
             * Page Content
             */
            $exq = $this->connection->prepare("SELECT * FROM modules");
            $exq->execute();
            $modules = $exq->fetchAll(PDO::FETCH_ASSOC);
            ...
            $this->controller->set("modules", $modules_rows);
            ...
            $this->controller->set("modules_repo", $repo_modules_rows);
        }
    }
